"""
compute_classical_md.py — Classical FF MD compute script for H₂O
=================================================================
Runs a SPC/E-like harmonic force field MD trajectory and saves the
result to classical_data.npz (ready for render_classical_md.py).

Usage:
    python scripts/run_md/compute_classical_md.py           # run and save
    python scripts/run_md/compute_classical_md.py --force   # re-run even if npz exists
"""
...
NPZ_PATH = os.path.join(REPO_ROOT, "product", "data", "classical_data.npz")
