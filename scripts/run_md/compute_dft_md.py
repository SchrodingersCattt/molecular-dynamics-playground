"""
compute_dft_md.py — RHF/STO-3G MD compute script for H₂O
==========================================================
Runs a 20-step RHF/STO-3G MD trajectory and saves the result to
md_data.npz (ready for render_dft_md.py to render).

Usage:
    python scripts/run_md/compute_dft_md.py           # run and save (~2 min)
    python scripts/run_md/compute_dft_md.py --force   # re-run even if npz exists
"""
...
NPZ_PATH = os.path.join(REPO_ROOT, "product", "data", "md_data.npz")
