...
ASSETS = {
    "md": ROOT / "qa" / "02_classical_lj" / "source" / "mattervis_v3" / "lj_force.png",
    "aimd": ROOT / "qa" / "03_aimd_scf" / "source" / "mattervis_multistep_v3" / "ion_00_scf_06_density.png",
    "nnmd": ROOT / "qa" / "04_dpmd_native" / "mattervis_v3" / "focus_force.png",
}
BLUE = "#4E9BB5"
OLIVE = "#A89B52"
GREEN = "#2F8562"
