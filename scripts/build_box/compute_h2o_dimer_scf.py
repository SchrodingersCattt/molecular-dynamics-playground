...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "product" / "data" / "h2o_dimer_scf.npz")
    parser.add_argument("--metadata", type=Path, default=ROOT / "product" / "data" / "h2o_dimer_scf.json")
    ...
    metadata = {
        "method": "RHF/STO-3G",
        "engine": "scripts/run_md/engine_rhf.py generalized to the H2O dimer",
