...
4. Readability or print-scale problem: no remaining blocking issue; the A4 figure respects 10 pt minimum text and the 1920 x 1080 video respects 18 pt minimum text with clearly visible arrowheads.
...
Action taken: stop after the fresh render because all five first-pass problems are fixed and no new blocking issue is visible.
