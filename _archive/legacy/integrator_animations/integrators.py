...
Render each scene individually:
    manim -pqh integrator_animations/integrators.py Scene0_Mechanics
    manim -pqh integrator_animations/integrators.py Scene1_PhaseSpace
    manim -pqh integrator_animations/integrators.py Scene2_ManyBody
    manim -pqh integrator_animations/integrators.py Scene3_Discretization
